...
private fun String.toPrinterProfile(): OrmaPrinterProfile =
    OrmaPrinterProfile(
        ...
        printLogo = jsonBoolean("printLogo") ?: false,
        headerAlignment = jsonString("headerAlignment") ?: "center",
        showBusinessAddress = jsonBoolean("showBusinessAddress") ?: true,
        showCatalogQr = jsonBoolean("showCatalogQr") ?: false,
        showTimedGreeting = jsonBoolean("showTimedGreeting") ?: true,
        notes = jsonString("notes"),
        status = jsonString("status").orEmpty(),
        createdAt = jsonString("createdAt").orEmpty(),
        updatedAt = jsonString("updatedAt").orEmpty(),
...
private fun OrmaPrinterDraft.toPrinterRequestJson(): String =
    buildJsonObject(
        ...
        "printLogo" to JsonValue.BooleanValue(printLogo),
        "headerAlignment" to JsonValue.StringValue(headerAlignment),
        "showBusinessAddress" to JsonValue.BooleanValue(showBusinessAddress),
        "showCatalogQr" to JsonValue.BooleanValue(showCatalogQr),
        "showTimedGreeting" to JsonValue.BooleanValue(showTimedGreeting),
        "notes" to JsonValue.StringValue(notes.blankToNull()),
    )
