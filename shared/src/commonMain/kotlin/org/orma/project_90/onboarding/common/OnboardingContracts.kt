...
internal data class OnboardingUiState(
    ...
    val workspaceReceiptLogoFileName: String = "",
    val workspaceReceiptLogoUrl: String = "",
    ...
    val receiptLogoUploadLoading: Boolean = false,
...
internal data class OnboardingActions(
    ...
    val onReceiptLogoUploadRequest: () -> Unit,
    ...
    val onDashboardNotificationOrderConsumed: (String) -> Unit,
